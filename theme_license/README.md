...
- 利用について
  - 本テーマを購入された方が所有権を有します。
  - 本テーマを購入された方の所属する団体・企業のウェブサイトをする場合は、その購入された方が所属する団体・企業が所有権を有します。
  - 仲介者を通して本テーマを購入されたた場合、所有者は仲介者ではなく、仲介者に依頼したクライアントが所有権を有します。
...
- 免責事項
  - 本テーマのご利用によって生じた如何なる損害やトラブルについて、一切責任を負いません。
